...
Il faut écrire la fonction `palindrome` (en utilisant les pointeurs explicitement) qui renvoie `1` si la chaine de caractère passée en argument est un palindrome et `0` sinon.
